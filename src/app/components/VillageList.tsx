  ...
  return (
    <div className="flex flex-col h-full bg-gray-50">
      ...
      <div className="p-4 bg-white border-b border-gray-200">
        <h2 className="flex items-center gap-2 text-gray-800 mb-3 text-[16px] font-semibold">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-[14px] border border-gray-200 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
          <select
            value={filterState}
            onChange={(e) => setFilterState(e.target.value)}
            className="w-full sm:w-auto min-w-[140px] py-2 px-3 text-[14px] border border-gray-200 rounded-lg bg-gray-50 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            ...
            >
              ...
              <div className="p-3">
                <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-2 gap-2">
                  ...
                  <span
                    className={`px-2 py-0.5 rounded-full text-[11px] border self-start sm:self-auto ${getScoreColor(
                ...
                <div className="mt-3 flex flex-col sm:flex-row gap-2">
                  <button
                    className={`w-full sm:flex-1 flex items-center justify-center gap-1.5 py-2 sm:py-1.5 rounded-lg text-[13px] transition-colors ${
                      isSelected
                  ...
                  {onShowImages && (
                    <button
                      className="w-full sm:w-auto flex items-center justify-center gap-1.5 px-3 py-2 sm:py-1.5 rounded-lg text-[13px] bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors border border-gray-200"
                      onClick={(e) => {
                        e.stopPropagation();
